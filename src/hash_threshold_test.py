...
expression_length_dist = (70, 5)
duplicates_count_dist = (2, 1)
error_count_dist = (4, 3)

hash_threshold_range = (2, 50)
...
def expression_length_test():
    ...
    for threshold in range(hash_threshold_range[0], hash_threshold_range[1] + 1):
        print("Calculating stats for threshold {}...".format(threshold))
        ...
        test_results[threshold] = metrics

    plot_metrics(test_results, "Threshold")
